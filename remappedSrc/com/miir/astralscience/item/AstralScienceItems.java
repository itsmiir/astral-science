...
public class AstralScienceItems {
//    MATERIALS
    ...
    public static final Item NEPHRYLL_POWDER = new NephryllPowderItem(new Item.Settings().maxCount(64).rarity(Rarity.UNCOMMON).group(ItemGroup.MATERIALS));
    public static final Item NEPHRYLL_PEARL = new Item(new Item.Settings().maxCount(64).rarity(Rarity.UNCOMMON).group(ItemGroup.MATERIALS));
...
//    public static final Item FLIGHT_SUIT_PANTS = new ArmorItem(LIGHT_COMPOSITE, EquipmentSlot.LEGS, new Item.Settings().rarity(Rarity.COMMON));
    public static final Item NEPHRYLL_BOOTS = new ArmorItem(NEPHRYLL, EquipmentSlot.FEET, new Item.Settings().rarity(Rarity.UNCOMMON).group(ItemGroup.COMBAT));
