...
//    public static final Block STARSHIP_HELM = new StarshipHelmBlock(FabricBlockSettings.of(METAL_CLONE).nonOpaque().requiresTool().sounds(BlockSoundGroup.NETHERITE).strength(1.5F, 6.0F));
    ...
    public static final Block FIRECAP = new FirecapPlantBlock(FabricBlockSettings.of(Material.ORGANIC_PRODUCT, MapColor.ORANGE).noCollision().breakInstantly().sounds(BlockSoundGroup.SHROOMLIGHT).luminance((state) -> 10), () -> AstralFeatures.GIANT_FIRECAP_CONFIGURED);
