...
public class LimestoneMountainSurfaceBuilder extends SurfaceBuilder<TernarySurfaceConfig> {
    public LimestoneMountainSurfaceBuilder(Codec<TernarySurfaceConfig> codec) {
        super(codec);
    }
    ...
    public void generate(Random random, Chunk chunk, Biome biome, int i, int j, int k, double d, BlockState blockState, BlockState blockState2, int l, long m, TernarySurfaceConfig ternarySurfaceConfig) {
        if (d > 1.0D) {
            SurfaceBuilder.DEFAULT.generate(random, chunk, biome, i, j, k, d, blockState, blockState2, l, m, AstralScienceSurfaceBuilder.LIMESTONE_CONFIG);
        } else {
