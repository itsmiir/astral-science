...
public class GiantFlowerFeature extends AbstractBranchingPlantFeature {
    ...
    public GiantFlowerFeature(int maxBranches, int maxTrunkSize, int avgTrunkSize, float branchChance, int minTrunkHeight, boolean canBend, float bendChance, float tallness, BlockStateProvider trunkProvider, BlockStateProvider canopyProvider, BlockStateProvider decorationProvider, Tag<Block> replaceable) {
        super(1, 15, 10, 0f, 6, true, 0.25f, 0.9f, new SimpleBlockStateProvider(AstralBlocks.GIANT_STEM.getDefaultState()), new SimpleBlockStateProvider(AstralBlocks.CYAN_PETAL.getDefaultState()), new SimpleBlockStateProvider(Blocks.AIR.getDefaultState()), replaceable, false);
    }
