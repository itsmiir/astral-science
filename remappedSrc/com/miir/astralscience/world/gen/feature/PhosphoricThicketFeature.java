...
public class PhosphoricThicketFeature extends AbstractBranchingPlantFeature {
    public PhosphoricThicketFeature() {
        super(1, 100, 75, 0.1F, 4, false, 0.3f, 0.8f, new SimpleBlockStateProvider(AstralBlocks.BRAMBLEWOOD_LOG.getDefaultState()), new PhosphoricThicketCanopyStateProvider(), new SimpleBlockStateProvider(Blocks.AIR.getDefaultState()), AstralTags.GIANT_PLANT_REPLACEABLE, false);
    }
