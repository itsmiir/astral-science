...
public class GiantFirecapFeature extends AbstractBranchingPlantFeature {
    ...
    public GiantFirecapFeature() {
        super(1, 15, 10, 0.25F, 3, true, 0.5F, 0.15F, new SimpleBlockStateProvider(AstralBlocks.FIRECAP_HYPHAE.getDefaultState()), new FirecapCanopyProvider(), new FirecapDecorationProvider(), AstralTags.GIANT_FIRECAP_REPLACEABLE, true);
    }
