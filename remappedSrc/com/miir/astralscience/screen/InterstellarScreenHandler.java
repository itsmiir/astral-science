...
import com.miir.interstellar.client.gui.screen.StarshipHelmFuelSlot;
...
public abstract class InterstellarScreenHandler extends ScreenHandler {
    public Inventory inventory;
    protected InterstellarScreenHandler(@Nullable ScreenHandlerType<?> type, int syncId) {
        super(type, syncId);
    }
