...
import com.miir.astralscience.client.gui.screen.ingame.StarshipHelmScreen;
...
public abstract class AstralScreens {
    ...
    public static ScreenHandlerType<StarshipHelmScreenHandler> STARSHIP_HELM_SCREEN_HANDLER;
    ...
    public static void register() {
        ...
        STARSHIP_HELM_SCREEN_HANDLER = ScreenHandlerRegistry.registerExtended(AstralScience.id("starship_helm"), StarshipHelmScreenHandler::new);
    ...
    public static void registerClient() {
        ScreenRegistry.register(STARSHIP_HELM_SCREEN_HANDLER, StarshipHelmScreen::new);
